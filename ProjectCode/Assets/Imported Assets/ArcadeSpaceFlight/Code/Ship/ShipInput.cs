...
public class ShipInput : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {            
            ...
            if (addRoll)
                roll = (-Input.GetAxis("Horizontal") * 0.5f) * mouseSensitivity;
    ...
    private void SetStickCommandsUsingMouse()
    {
        ...
        pitch = ((mousePos.y - (Screen.height * 0.5f)) / (Screen.height* 0.5f)) * mouseSensitivity;
        yaw = ((mousePos.x - (Screen.width * 0.5f)) / (Screen.width * 0.5f)) * mouseSensitivity;
